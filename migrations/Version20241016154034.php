...
final class Version20241016154034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('
            ...
            ADD CONSTRAINT FK_D5607B4C12469DE2 
            FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE
        ');

        $this->addSql('
            ALTER TABLE category_recipe 
            ADD CONSTRAINT FK_D5607B4C59D8A214 
    ...
    {
        $this->addSql('
            ALTER TABLE category_recipe DROP FOREIGN KEY FK_D5607B4C12469DE2
        ');

        $this->addSql('
            ALTER TABLE category_recipe DROP FOREIGN KEY FK_D5607B4C59D8A214
        ');
